...
{
    std::array<XMFLOAT3,3> vertices = // 예제14.1
	{
...
//	std::array<std::int16_t, 4> indices = { 0, 1, 2, 3 };
	std::array<std::int16_t, 3> indices = { 0, 1, 2 }; // 예제14.1
	...
	quadSubmesh.IndexCount = 3; // 예제14.1
...
void BasicTessellationApp::BuildRenderItems()
{
	...
	quadPatchRitem->PrimitiveType = D3D_PRIMITIVE_TOPOLOGY_3_CONTROL_POINT_PATCHLIST;  // 예제14.1
	//quadPatchRitem->PrimitiveType = D3D_PRIMITIVE_TOPOLOGY_4_CONTROL_POINT_PATCHLIST;  // 원본
