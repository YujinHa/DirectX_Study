...
//	transparencyBlendDesc.SrcBlend = D3D12_BLEND_INV_SRC_COLOR; // 연습문제 10.1
//	transparencyBlendDesc.DestBlend = D3D12_BLEND_SRC_COLOR; // 연습문제 10.1
	transparencyBlendDesc.BlendOp = D3D12_BLEND_OP_ADD;
//	transparencyBlendDesc.BlendOp = D3D12_BLEND_OP_SUBTRACT; // 연습문제 10.1
//	transparencyBlendDesc.BlendOp = D3D12_BLEND_OP_MAX; // 연습문제 10.1
	transparencyBlendDesc.SrcBlendAlpha = D3D12_BLEND_ONE;
	transparencyBlendDesc.DestBlendAlpha = D3D12_BLEND_ZERO;
	transparencyBlendDesc.BlendOpAlpha = D3D12_BLEND_OP_ADD;
	transparencyBlendDesc.LogicOp = D3D12_LOGIC_OP_NOOP;
	transparencyBlendDesc.RenderTargetWriteMask = D3D12_COLOR_WRITE_ENABLE_ALL;
//	transparencyBlendDesc.RenderTargetWriteMask = D3D12_COLOR_WRITE_ENABLE_BLUE | D3D12_COLOR_WRITE_ENABLE_ALPHA; // 연습문제 10.5
...
//	mRitemLayer[(int)RenderLayer::AlphaTested].push_back(wavesRitem.get());
//	mRitemLayer[(int)RenderLayer::Opaque].push_back(wavesRitem.get()); // 연습문제 10.2
...
//	mRitemLayer[(int)RenderLayer::Transparent].push_back(gridRitem.get()); // 연습문제 10.2
