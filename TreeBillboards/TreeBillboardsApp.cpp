...
void TreeBillboardsApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
  ...
  //      cmdList->DrawIndexedInstanced(ri->IndexCount - 16, 1, ri->StartIndexLocation, ri->BaseVertexLocation, 0); // 연습문제 12.6
		cmdList->DrawInstanced(4, 1, 0, 0); // 연습문제 12.6, 12.7
		cmdList->DrawInstanced(4, 1, 4, 0); // 연습문제 12.6, 12.7
		cmdList->DrawInstanced(4, 1, 8, 0); // 연습문제 12.6, 12.7
		cmdList->DrawInstanced(4, 1, 12, 0); // 연습문제 12.6, 12.7
    }
}
